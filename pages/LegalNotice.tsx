          ...
          <div className="prose prose-stone max-w-none text-stone-600 font-light leading-relaxed">
            ...
            <div className="bg-stone-50 p-8 border border-stone-100 mb-12">
              <ul className="space-y-4 list-none pl-0">
                <li><strong className="font-bold text-stone-900">Titular:</strong> Joel Marin Hidalgo (Vield Reformas)</li>
                ...
                <li><strong className="font-bold text-stone-900">Correo electrónico:</strong> vieldreformas@gmail.com</li>
              </ul>
            </div>
            ...
            <p className="mb-6">
              Este sitio web tiene como finalidad informar sobre los servicios de reformas integrales y construcción de Vield Reformas.
            </p>
            <p>
              El acceso y uso de la web atribuye la condición de usuario e implica la aceptación plena y sin reservas de las condiciones aquí expuestas. El usuario se compromete a hacer un uso adecuado de los contenidos y servicios que Vield Reformas ofrece a través de su portal y a no emplearlos para incurrir en actividades ilícitas, ilegales o contrarias a la buena fe y al orden público.
            </p>
          </div>
        </FadeIn>
      </Container>
